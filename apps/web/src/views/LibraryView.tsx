...
export const LibraryView: React.FC = () => {
  ...
  return (
    <div className="view-body" style={{ maxWidth: '1180px', margin: '0 auto', padding: '40px 24px 120px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : showDetailPanel ? '190px minmax(0, 1fr) 320px' : '190px minmax(0, 1fr)', gap: '20px', alignItems: 'start', marginTop: '18px', transition: 'grid-template-columns 0.25s ease' }}>
        {/* Filters */}
        {!isMobile && (
